...
from projects.vCLR_deformable_mask.modeling import (
    DINO,
...
model = L(DINO)(
    ...
    criterion=L(DINOCriterion)(
        ...
        # loss_class_type="vfl_loss",
        # loss_class_type="active_loss",
        alpha=0.25,
        gamma=2.0,
        two_stage_binary_cls=False,
    ),
    consistency_criterion = L(ConsisCriterion)(
        matcher=L(HungarianMatcher)(
            cost_class=2.0,
            cost_bbox=5.0,
            cost_giou=2.0,
