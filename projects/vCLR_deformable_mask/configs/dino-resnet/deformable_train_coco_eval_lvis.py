...
# training
register_coco_instances("openworld_allcoco_classes_train2017", {}, 'datasets/vCLR_coco_train2017_top5.json', 'datasets/coco/train2017/')
register_coco_instances("openworld_LVIS_noncoco_val2017", {}, 'datasets/openworld_lvis_noncoco_val_correct.json', 'datasets/lvis_val/')
register_coco_instances("openworld_objects365_noncoco_val2017", {}, 'datasets/openworld_objects365_noncoco_val.json', 'datasets/object365_val/')


dataloader.train = L(build_detection_train_loader)(
    dataset=L(get_detection_dataset_dicts)(names="openworld_allcoco_classes_train2017", filter_empty=True), # must be true
...
dataloader.test = L(build_detection_test_loader)(
    dataset=L(get_detection_dataset_dicts)(names="openworld_LVIS_noncoco_val2017", filter_empty=True),
